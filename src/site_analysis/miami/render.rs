//! Faceted Miami-plot SVG assembly.
//!
...
//! We hand-build the SVG string and write `{prefix}.miami.svg`.
...
pub fn render_miami(
    ...
    for (pi, panel) in panels.iter().enumerate() {
        ...
        /////////////////////////////////////////////////////////////
        // Top: epi lollipops (vector; dense panels stay SVG)      //
        /////////////////////////////////////////////////////////////
    ...
    let pth = format!("{}.miami.svg", opts.out_prefix.as_ref());
